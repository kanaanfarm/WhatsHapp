const CACHE="connectchat-v6751";
const ASSETS=["/","/index.html","/style.css?v=6751","/app.js?v=6751","/manifest.json","/logo.svg"];
...
self.addEventListener("notificationclick",event=>{
  ...
  const target=event.notification.data?.url||"/?v=6751";
