const CACHE="connectchat-v6749";
const ASSETS=["/","/index.html","/style.css?v=6749","/app.js?v=6749","/manifest.json","/logo.svg"];
...
self.addEventListener("notificationclick",event=>{
  ...
  const target=event.notification.data?.url||"/?v=6749";
