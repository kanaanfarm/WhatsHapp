const CACHE="connectchat-v6768";
const ASSETS=["/","/index.html","/style.css?v=6768","/app.js?v=6768","/manifest.json","/logo.svg"];
...
self.addEventListener("notificationclick",event=>{
  ...
  const target=event.notification.data?.url||"/?v=6768";
