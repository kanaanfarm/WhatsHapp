const CACHE="connectchat-v6754";
const ASSETS=["/","/index.html","/style.css?v=6754","/app.js?v=6754","/manifest.json","/logo.svg"];
...
self.addEventListener("notificationclick",event=>{
  ...
  const target=event.notification.data?.url||"/?v=6754";
