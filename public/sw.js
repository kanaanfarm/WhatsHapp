const CACHE="connectchat-v6760";
const ASSETS=["/","/index.html","/style.css?v=6760","/app.js?v=6760","/manifest.json","/logo.svg"];
...
self.addEventListener("notificationclick",event=>{
  ...
  const target=event.notification.data?.url||"/?v=6760";
