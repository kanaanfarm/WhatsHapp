const CACHE="connectchat-v6763";
const ASSETS=["/","/index.html","/style.css?v=6763","/app.js?v=6763","/manifest.json","/logo.svg"];
...
self.addEventListener("notificationclick",event=>{
  ...
  const target=event.notification.data?.url||"/?v=6763";
