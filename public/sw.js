const CACHE="connectchat-v6762";
const ASSETS=["/","/index.html","/style.css?v=6762","/app.js?v=6762","/manifest.json","/logo.svg"];
...
self.addEventListener("notificationclick",event=>{
  ...
  const target=event.notification.data?.url||"/?v=6762";
