const CACHE="connectchat-v6752";
const ASSETS=["/","/index.html","/style.css?v=6752","/app.js?v=6752","/manifest.json","/logo.svg"];
...
self.addEventListener("notificationclick",event=>{
  ...
  const target=event.notification.data?.url||"/?v=6752";
