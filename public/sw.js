const CACHE="connectchat-v6755";
const ASSETS=["/","/index.html","/style.css?v=6755","/app.js?v=6755","/manifest.json","/logo.svg"];
...
self.addEventListener("notificationclick",event=>{
  ...
  const target=event.notification.data?.url||"/?v=6755";
